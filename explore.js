          ...
          <div class="event-details">
            ...
            ${
              ev.registrationCloseDate 
                ? `<div class="detail-item detail-full" style="color: ${isClosed ? 'var(--neon-red)' : 'var(--text-sub)'};"><span>⏳</span> <strong>Reg Closes:</strong> <span class="detail-val">12 AM Midnight (${formatToDDMMYYYY(ev.registrationCloseDate)}) ${isClosed ? '🔴 (Closed)' : '🟢 (OPEN)'}</span></div>`
                : ""
            }
          </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 20px; align-items: start; margin-top: 15px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 14px;">
          ...
          <div class="event-details" style="margin: 0;">
            ...
            <div class="detail-item detail-full" style="color: ${isClosed ? 'var(--neon-red)' : 'var(--neon-green)'};"><span>⏳</span> <strong>Reg Close:</strong> <span class="detail-val">${regCloseText}</span></div>
          </div>
